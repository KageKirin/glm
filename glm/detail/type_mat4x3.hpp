...
namespace glm
{
	...
	public:
		...
		GLM_FUNC_DECL GLM_CONSTEXPR_CTOR mat() GLM_DEFAULT;
		GLM_FUNC_DECL GLM_CONSTEXPR_CTOR mat(mat<4, 3, T, Q> const& m) GLM_DEFAULT;
		template<qualifier P>
		GLM_FUNC_DECL GLM_CONSTEXPR_CTOR mat(mat<4, 3, T, P> const& m);

		GLM_FUNC_DECL explicit GLM_CONSTEXPR_CTOR mat(T const& x);
		GLM_FUNC_DECL GLM_CONSTEXPR_CTOR mat(
		...
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<4, 3, U, P> const& m);

		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<2, 2, T, Q> const& x);
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<3, 3, T, Q> const& x);
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<4, 4, T, Q> const& x);
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<2, 3, T, Q> const& x);
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<3, 2, T, Q> const& x);
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<2, 4, T, Q> const& x);
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<4, 2, T, Q> const& x);
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<3, 4, T, Q> const& x);
