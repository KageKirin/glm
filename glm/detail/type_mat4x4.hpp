...
namespace glm
{
	...
	public:
		...
		GLM_FUNC_DECL GLM_CONSTEXPR_CTOR mat(mat<4, 4, T, Q> const& m) GLM_DEFAULT;
		template<qualifier P>
		GLM_FUNC_DECL GLM_CONSTEXPR_CTOR mat(mat<4, 4, T, P> const& m);
		...
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<4, 4, U, P> const& m);
		...
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<4, 3, T, Q> const& x);
