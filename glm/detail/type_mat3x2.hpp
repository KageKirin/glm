...
namespace glm
{
	...
	public:
		...
		GLM_FUNC_DECL GLM_CONSTEXPR_CTOR mat(mat<3, 2, T, Q> const& m) GLM_DEFAULT;
		template<qualifier P>
		GLM_FUNC_DECL GLM_CONSTEXPR_CTOR mat(mat<3, 2, T, P> const& m);
		...
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR_CTOR mat(mat<3, 2, U, P> const& m);
